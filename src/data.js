...
export const projectsData = [
  ...
  },
  {
    ...
    alt: "FinSpace",
    title: "FinSpace",
    info: "A financial technology web app built with React to offer financial services.",
  ...
  },
  {
    ...
    alt: "GPT3",
    title: "GPT3",
    info: "A static landing page built with React showcasing the capabilities of GPT-3 by OpenAI.",
  ...
  },
  {
    ...
    alt: "Admin Panel",
    title: "Admin Portal",
    info: "An interactive admin portal built with React to allow authorized users to carry out activities.",
  ...
  },
  {
    ...
    info: "An e-commerce web application built with React to allow users to make orders.",
